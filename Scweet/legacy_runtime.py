...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str,
                        help='Scraping Mode. ["API", "BROWSER"]', default=5)
    ...
    # TODO: mode in ['API', 'BROWSER']
    scweet = Scweet(None, None, cookies_path, user_agent, disable_images, env_path, n_splits, concurrency, headless, mode)
