...
def configure_logging(
    *,
    ...
    Args:
        ...
        api_level: Override the level for Scweet.api_engine (if set).
        transaction_level: Override the level for Scweet.transaction (if set).
    """
    ...
    logging.getLogger("Scweet.api_engine").setLevel(resolved_api_level)
    logging.getLogger("Scweet.transaction").setLevel(resolved_transaction_level)
