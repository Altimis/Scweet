...
# scrape top tweets with the words 'covid','covid19' and without replies.
...
# scrape english top tweets geolocated less than 200 km from Alicante (Spain) Lat=38.3452, Long=-0.481006. 
